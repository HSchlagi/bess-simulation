#!/usr/bin/env python3
"""
Test-Script für Frontend-Verhalten
"""
...
def test_frontend_behavior():
    """Testet das Frontend-Verhalten"""
    
    project_id = 1  # BESS Hinterstoder
    
    try:
        print("🧪 Teste Frontend-Verhalten...")
        
        # 1. Aktuelles Projekt laden (wie das Frontend es macht)
        ...
        if response.status_code == 200:
            ...
            form_data = {
                ...
                "hydro_power": 650,
                "other_power": None,
                "daily_cycles": 3.0,  # Hier setzen wir 3.0
            ...
            if response.status_code == 200:
                ...
                if response.status_code == 200:
                    ...
                    if daily_cycles == 3.0:
                        print("✅ daily_cycles korrekt auf 3.0 gesetzt!")
                    else:
                        print(f"❌ daily_cycles falsch: erwartet 3.0, erhalten {daily_cycles}")
