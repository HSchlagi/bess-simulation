#!/usr/bin/env python3
"""
Finaler korrigierter Datenbank-Import
"""
...
def final_db_import():
    ...
    print("🔍 Finaler korrigierter Datenbank-Import...")
    print("=" * 50)
    ...
    try:
        ...
        # Neues Lastprofil erstellen (mit korrekter Spalten-Struktur)
        profile_name = "Test-Lastprofil 2024"
        print(f"\n2. Erstelle Lastprofil: {profile_name}")
        
        cursor.execute("""
            INSERT INTO load_profile (project_id, name, description, data_type, time_resolution, created_at)
            VALUES (?, ?, ?, ?, ?, datetime('now'))
