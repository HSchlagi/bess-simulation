#!/usr/bin/env python3
"""
Test-Script für daily_cycles 2.0 Problem
"""

import requests
import json

def test_daily_cycles_2_0():
    """Testet das daily_cycles Problem mit 2.0"""
    
    project_id = 1  # BESS Hinterstoder
    
    try:
        print("🧪 Teste daily_cycles 2.0 Problem...")
