#!/usr/bin/env python3
"""
Test-Script für daily_cycles 2.5 Problem
"""

import requests
import json

def test_daily_cycles_2_5():
    """Testet das daily_cycles Problem mit 2.5"""
    
    project_id = 1  # BESS Hinterstoder
    
    try:
        print("🧪 Teste daily_cycles 2.5 Problem...")
        ...
        if response.status_code == 200:
            ...
            # 2. Projekt mit daily_cycles = 2.5 aktualisieren
            print("2. Aktualisiere daily_cycles auf 2.5...")
            update_data = {
            ...
            if response.status_code == 200:
                ...
                if response.status_code == 200:
                    ...
                    if daily_cycles == 2.5:
                        ...
                        print("4. Vollständige Projekt-Analyse:")
